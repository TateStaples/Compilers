000\003\000\002\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\012\000\117\000\013\000\106\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\128\000\003\000\002\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\131\000\003\000\002\000\004\000\001\000\000\000\
\\012\000\132\000\013\000\106\000\000\000\
\\000\000\
\\001\000\135\000\003\000\002\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\139\000\003\000\002\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\143\000\003\000\002\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\001\000\145\000\003\000\002\000\004\000\001\000\000\000\
\\000\000\
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | ID of unit ->  (string) | fun_declaration of unit ->  (A.dec)
 | var_declaration of unit ->  (A.dec)
 | type_field of unit ->  (A.field)
 | type_fields of unit ->  (A.field list) | type' of unit ->  (A.ty)
 | type_declaration of unit ->  (A.dec)
 | declaration of unit ->  (A.dec)
 | declaration_list of unit ->  (A.dec list)
 | field_list of unit ->  ( ( Symbol.symbol * A.exp * int )  list)
 | exp_seq of unit ->  ( ( A.exp * int )  list)
 | exp_list of unit ->  (A.exp list) | arithmetic of unit ->  (A.exp)
...
|  ( 7, ( ( _, ( MlyValue.arithmetic arithmetic1, arithmetic1left, 
...
result = MlyValue.exp (fn _ => let val  (ID as ID1) = ID1 ()
 val  (exp as exp1) = exp1 ()
 in (
A.AssignExp{var=A.SimpleVar(Symbol.symbol(ID), IDleft), exp=exp, pos=IDleft}
)
end)
 in ( LrTable.NT 0, ( result, ID1left, exp1right), rest671)
end
|  ( 10, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.exp_list 
...
|  ( 14, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.field_list 
...
|  ( 22, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.exp_seq 
...
|  ( 23, ( ( _, ( _, _, END1right)) :: _ :: ( _, ( 
MlyValue.declaration_list declaration_list1, _, _)) :: ( _, ( _, (
LETleft as LET1left), _)) :: rest671)) => let val  result = 
MlyValue.exp (fn _ => let val  (declaration_list as declaration_list1)
 = declaration_list1 ()
 in (A.LetExp{decs=declaration_list, body=A.SeqExp([]), pos=LETleft})

end)
 in ( LrTable.NT 0, ( result, LET1left, END1right), rest671)
end
|  ( 24, ( ( _, ( MlyValue.exp_seq exp_seq1, _, exp_seq1right)) :: _
...
|  ( 26, ( ( _, ( MlyValue.exp_list exp_list1, _, exp_list1right)) ::
...
MlyValue.ID ID1, IDleft, _)) :: _ :: ( _, ( MlyValue.field_list 
field_list1, field_list1left, _)) :: rest671)) => let val  result = 
MlyValue.field_list (fn _ => let val  (field_list as field_list1) = 
field_list1 ()
 val  (ID as ID1) = ID1 ()
 val  (exp as exp1) = exp1 ()
...
|  ( 32, ( ( _, ( MlyValue.declaration_list declaration_list1, _, 
...
declaration1) = declaration1 ()
 ...
 in (add_or_combine_declaration(declaration, declaration_list))
end)
 in ( LrTable.NT 7, ( result, declaration1left, declaration_list1right
), rest671)
end
|  ( 33, ( ( _, ( MlyValue.declaration declaration1, declaration1left,
...
|  ( 34, ( ( _, ( MlyValue.type_declaration type_declaration1, 
...
|  ( 35, ( ( _, ( MlyValue.var_declaration var_declaration1, 
...
|  ( 36, ( ( _, ( MlyValue.fun_declaration fun_declaration1, 
fun_declaration1left, fun_declaration1right)) :: rest671)) => let val 
 result = MlyValue.declaration (fn _ => let val  (fun_declaration as 
...
|  ( 37, ( ( _, ( MlyValue.type' type'1, _, type'1right)) :: _ :: ( _,
 ( MlyValue.ID ID1, IDleft, _)) :: ( _, ( _, TYPE1left, _)) :: rest671
)) => let val  result = MlyValue.type_declaration (fn _ => let val  (
ID as ID1) = ID1 ()
 val  (type' as type'1) = type'1 ()
 in (A.TypeDec([{name=Symbol.symbol(ID), ty=type', pos=IDleft}]))
end)
 in ( LrTable.NT 9, ( result, TYPE1left, type'1right), rest671)
end
|  ( 38, ( ( _, ( MlyValue.ID ID1, (IDleft as ID1left), ID1right)) :: 
rest671)) => let val  result = MlyValue.type' (fn _ => let val  (ID
 as ID1) = ID1 ()
 in (A.NameTy(Symbol.symbol(ID), IDleft))
end)
 in ( LrTable.NT 10, ( result, ID1left, ID1right), rest671)
end
|  ( 39, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.type_fields 
type_fields1, _, _)) :: ( _, ( _, LBRACE1left, _)) :: rest671)) => let
 val  result = MlyValue.type' (fn _ => let val  (type_fields as 
...
|  ( 43, ( ( _, ( MlyValue.type_fields type_fields1, _, 
type_fields1right)) :: _ :: ( _, ( MlyValue.type_field type_field1, 
type_field1left, _)) :: rest671)) => let val  result = 
MlyValue.type_fields (fn _ => let val  (type_field as type_field1) = 
type_field1 ()
...
rest671)) => let val  result = MlyValue.fun_declaration (fn _ => let
 val  (ID as ID1) = ID1 ()
 val  (type_fields as type_fields1) = type_fields1 ()
 val  (exp as exp1) = exp1 ()
 in (
...
MlyValue.ID ID2, _, _)) :: _ :: _ :: ( _, ( MlyValue.type_fields 
type_fields1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, IDleft, _)) :: (
 _, ( _, (FUNCTIONleft as FUNCTION1left), _)) :: rest671)) => let val 
 result = MlyValue.fun_declaration (fn _ => let val  (ID as ID1) = ID1
 ()
 val  (type_fields as type_fields1) = type_fields1 ()
 val  ID2 = ID2 ()
 val  (exp as exp1) = exp1 ()
...
MlyValue.fun_declaration (fn _ => let val  (ID as ID1) = ID1 ()
 val  (exp as exp1) = exp1 ()
 in (
...
PLUSleft, _)) :: ( _, ( MlyValue.exp exp1, exp1left, _)) :: rest671))
 => let val  result = MlyValue.arithmetic (fn _ => let val  exp1 = 
exp1 ()
 val  exp2 = exp2 ()
...
EQleft, _)) :: ( _, ( MlyValue.exp exp1, exp1left, _)) :: rest671)) =>
 let val  result = MlyValue.arithmetic (fn _ => let val  exp1 = exp1
 ()
 val  exp2 = exp2 ()
